...
fn test_remove_tokens() {
    ...
    assert(erc20.allowance(account, token_remover.contract_address) == amount, 'Allowance not set');
    ...
    assert(erc20.allowance(account, token_remover.contract_address) == 0, 'Allowance not changed');
